 ...
 */
#define ERR_STATUS_STUCK                                0x21 

#define ERR_STATUS_INIT                                 0x30
#define ERR_STATUS_CALI                                 0x31


/*
 * Error codes for remote peer, operation result part
 */
#define ERR_OP_FAILED                                   0x41
#define ERR_SAVE_FAILED                                 0x42
...
/**
  ...
  *         -Others: failed, see definition of API return values
  */
uint8_t HAND_GetBeepSwitch(uint8_t hand_id, uint8_t *bpp_switch, HAND_NODE_ERROR_CALLBACK error_callback);
...
/**
  ...
  * @note
  * @param  hand_id: id of oHand
  * @param  raw_encoder: address of var to put raw encoder value of thumb's root, [0-2]
  * @param  pos: address of var to put mapped position of thumb's root, [0-2]
  * @param  error_callback: callback function of type HAND_NODE_ERROR_CALLBACK, can be NULL
  * @retval -HAND_RESP_SUCCESS: success
  *         -Others: failed, see definition of API return values
  */
...
/**
  ...
  *         -Others: failed, see definition of API return values
  */
uint8_t HAND_GetFingerLimit(uint8_t hand_id, uint8_t finger_id, uint16_t *low_limit, uint16_t *high_limit, HAND_NODE_ERROR_CALLBACK error_callback);


/**
  * @brief  Get raw position of finger
  * @note
  * @param  hand_id: id of oHand
...
/**
  ...
  * @param  hand_id: id of oHand
  * @param  finger_id: index of finger
  * @param  force_limit: address of var to put force limit
  * @param  error_callback: callback function of type HAND_NODE_ERROR_CALLBACK, can be NULL
  * @retval -HAND_RESP_SUCCESS: success
  *         -Others: failed, see definition of API return values
  */
...
/**
  ...
  *         -Others: failed, see definition of API return values
  */
uint8_t HAND_Calibrate(uint8_t hand_id, HAND_NODE_ERROR_CALLBACK error_callback);
...
/**
  * @brief  Set raw position for finger
  * @note
  * @param  hand_id: id of oHand
  * @param  finger_id: id of finger
  * @param  raw_pos: raw position of finger
  * @param  speed: encoder ticks per second
  * @param  error_callback: callback function of type HAND_NODE_ERROR_CALLBACK, can be NULL
  * @retval -HAND_RESP_SUCCESS: success
  *         -Others: failed, see definition of API return values
  */
uint8_t HAND_SetFingerPos(uint8_t hand_id, uint8_t finger_id, uint16_t raw_pos, uint16_t speed, HAND_NODE_ERROR_CALLBACK error_callback);
...
/**
  ...
  * @param  pos: target position, [0, 65535], mapped to [low_limit, high_limit] 
  * @param  speed: moving speed, [0, 255]
  * @param  error_callback: callback function of type HAND_NODE_ERROR_CALLBACK, can be NULL
  * @retval -HAND_RESP_SUCCESS: success
  *         -Others: failed, see definition of API return values
  */
uint8_t HAND_FingerMove(uint8_t hand_id, uint8_t finger_id, uint16_t pos, uint8_t speed, HAND_NODE_ERROR_CALLBACK error_callback);
